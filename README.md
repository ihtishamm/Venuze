...
> **Repository:** [github.com/ihtishamm/Venuze](https://github.com/ihtishamm/Venuze)
...
- **Persistence**: token stored in a cookie *and* mirrored in a persisted
...
- Mutations patch this cache **optimistically** and intentionally do *not* trigger
...
- **reqres.in is a mock API.** Writes don't persist server-side, so the app treats
  ...
  patches it optimistically (see *Technical decisions*).
